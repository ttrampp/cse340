...
-- Task 1 Query 4. Replace "small interiors" with "a huge interior" in GM Hummer description
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Task 1 Query 6. Update image and thumbnail paths to include "/vehicles"
UPDATE public.inventory
